...
class ImportantNews extends StatefulWidget {
  @override
  ImportantNewsState createState() => ImportantNewsState();
}

class ImportantNewsState extends State<ImportantNews> {
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Container(
                                                        ...
                                                        //459=Excise duty on Export of Petrol, Diesel & ATF
                                                        child: impnewlist[index]
                                                            .id! ==
                                                            '459'
                                                            ? ElevatedButton(
                                                          onPressed: () {
                                                            ...
                                                            Navigator
                                                              ...
                                                              MaterialPageRoute(
                                                                builder:
                                                                    (context) {
                                                                  return ExciseDutyScreen( slugname: 'prices/excise-duty-on-export-of-petrol-diesel-atf-and-special-additional-excise-duty-saed-on-domestic-crude-oil-production',
                                                                  );
                                                                },
                                                              ),
                                                            );
